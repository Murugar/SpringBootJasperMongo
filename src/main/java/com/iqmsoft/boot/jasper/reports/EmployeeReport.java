package com.iqmsoft.boot.jasper.reports;
...
public class EmployeeReport {
	...
	private Style createHeaderStyle() {
		...
		sb.setFont(Font.TIMES_NEW_ROMAN_BIG_BOLD);
	...
	private Style createDetailTextStyle() {
		...
		sb.setBorder(Border.THIN());
		sb.setBorderColor(Color.DARK_GRAY);
		sb.setTextColor(Color.BLUE);
		sb.setHorizontalAlign(HorizontalAlign.CENTER);
		sb.setVerticalAlign(VerticalAlign.MIDDLE);
		sb.setPaddingLeft(5);
	...
	private DynamicReport getReport(Style headerStyle, Style detailTextStyle, Style detailNumStyle)
		...
		titleStyle.setPadding(10);

		StyleBuilder subTitleStyle = new StyleBuilder(true);
		subTitleStyle.setHorizontalAlign(HorizontalAlign.CENTER);
		subTitleStyle.setFont(new Font(Font.BIG, Font._FONT_ARIAL, true));
		subTitleStyle.setTextColor(Color.RED);
		subTitleStyle.setPadding(20);
		
		report.setTitle("Employees Report");
		report.setTitleStyle(titleStyle.build());
		report.setSubtitle("Commission Received By Employees");
